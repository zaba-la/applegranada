...
export async function generateMetadata() {
  return {
    title: 'Soporte técnico Apple para estudiantes en Granada | AppleGranada',
    description:
      'Soluciones rápidas para Mac, iPad e iPhone cuando más los necesitas: entregas, TFG, exámenes. Soporte remoto desde 19€/h. Sin esperas, sin tecnicismos.',
    openGraph: {
      title: 'Soporte Apple para Estudiantes en Granada',
      description: 'Tu Mac falla antes de entregar? Resolvemos problemas de macOS, apps y rendimiento para estudiantes universitarios en Granada.',
    },
  };
}

const problems = [
  { icon: AlertTriangle, text: 'El Mac se congela o va lento justo cuando más lo necesitas' },
...
const activities = [
  {
    ...
    desc: 'Liberamos espacio, limpiamos procesos en segundo plano y dejamos el Mac funcionando como el primer día. Ideal cuando el disco está casi lleno o el equipo va lento.',
  },
  {
    icon: BookOpen,
    title: 'Recuperación de archivos y trabajos',
    desc: 'Recuperamos documentos, presentaciones y proyectos que creías perdidos. También configuramos copias automáticas para que no vuelva a pasar.',
  },
  {
    icon: GraduationCap,
    title: 'Configuración de software académico',
    desc: 'Xcode, Adobe Creative Cloud, Microsoft 365, Zotero, SPSS, MATLAB, Revit… Lo instalamos, activamos y configuramos correctamente en tu Mac.',
  },
  {
    icon: Wifi,
    title: 'Solución urgente el mismo día',
    desc: 'Sesión remota vía TeamViewer. Si tu Mac arranca y tiene internet, podemos resolver la mayoría de problemas en menos de una hora, sin que te muevas.',
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    initials: 'CR',
    quote: 'Llevaba semanas con el Mac lentísimo y sin espacio. En una sesión remota de 40 minutos lo dejaron como nuevo. Nunca había visto Xcode arrancar tan rápido.',
  },
  {
    name: 'Sofía Navarro',
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 py-20 text-center">
          <FadeIn>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-5 max-w-3xl mx-auto leading-tight">
              Tu Mac a punto para la entrega, el examen y el TFG.
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Soporte técnico Apple para estudiantes universitarios en Granada.
      ...
      <section className="container mx-auto px-4 py-16 max-w-4xl">
        <FadeIn>
          <h2 className="text-2xl font-semibold mb-8">Por qué elegir AppleGranada</h2>
        </FadeIn>
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            'Especialistas exclusivamente en Apple: macOS, iPadOS e iOS',
